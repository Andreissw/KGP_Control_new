    ...
    Sub AQV()
        ...
        ElseIf checkVhod = True Then 'Выход
            ...
            If PassRadio.Checked = True Then 'без дефектов
                ...
                SQL = "  USE FAS update [FAS].[dbo].[KGP_Control]  set  [PASS] = 1, [FAIL] = 0, [DefectCode] = null, END_DATE = CURRENT_TIMESTAMP, TestByEnd = '" & UserID & "',Description = '" & TextBox2.Text & "'  where barcode = '" & SN_IN.Text & "'"
                SelectString(SQL)
                TextLabel.ForeColor = Color.Green
            ...
            If Result <> "" Then
                ...
                Else 'Изделие на выходе
                    ...
                    If PassRadio.Checked = True Then 'Без брака
                        SQL = "  USE FAS update [FAS].[dbo].[KGP_Control_Sputnik]  set  [PASS] = 1, [FAIL] = 0, [DefectCode] = null, END_DATE = CURRENT_TIMESTAMP, TestByEnd = '" & UserID & "', Description = '" & TextBox2.Text & "'  where id = '" & SNMID & "'"
                        SelectString(SQL)
                        TextLabel.ForeColor = Color.Green
